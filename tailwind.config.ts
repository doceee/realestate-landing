  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        wordReveal:  { from: { opacity: '0', transform: 'translateY(20px) rotate(2deg)' }, to: { opacity: '1', transform: 'translateY(0) rotate(0deg)' } },
        navIn:       { from: { opacity: '0', transform: 'translateY(-16px)' }, to: { opacity: '1', transform: 'translateY(0)' } },
        cardRise:    { from: { opacity: '0', transform: 'translateY(40px)' }, to: { opacity: '1', transform: 'translateY(0)' } },
        countUp:     { from: { opacity: '0', transform: 'translateY(14px)' }, to: { opacity: '1', transform: 'translateY(0)' } },
  ...
  plugins: [
    function ({ addUtilities, addComponents }: { addUtilities: Function; addComponents: Function }) {
      addUtilities({
        ...
        /* Text utilities */
        '.text-gold-gradient': {
          background: 'linear-gradient(135deg, #d4b98a 0%, #b89a6a 50%, #8c7248 100%)',
